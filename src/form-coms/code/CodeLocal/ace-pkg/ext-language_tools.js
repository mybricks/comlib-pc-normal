  ...
  function (require, exports, module) {
    ...
    var SnippetManager = /** @class */ (function () {
      ...
      SnippetManager.prototype.tmStrFormat = function (str, ch, editor) {
        ...
        var fmtTokens =
          typeof ch.fmt == 'string' ? this.tokenizeTmSnippet(ch.fmt, 'formatString') : ch.fmt;
        var _self = this;
  ...
  function (require, exports, module) {
    ...
    var Autocomplete = /** @class */ (function () {
      ...
      Autocomplete.prototype.openPopup = function (editor, prefix, keepPopupPosition) {
        ...
        if (newRow && this.stickySelection) this.popup.setRow(this.autoSelect ? newRow : -1);
        else this.popup.setRow(this.autoSelect ? 0 : -1);
      ...
      Autocomplete.prototype.blurListener = function (e) {
        ...
        var fromTooltip =
          e.relatedTarget && this.tooltipNode && this.tooltipNode.contains(e.relatedTarget);
