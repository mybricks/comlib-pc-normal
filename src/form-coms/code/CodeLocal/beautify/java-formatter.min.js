!(function () {
  !(function () {
    ...
    var i = [
          ...
          (T.prototype.create_flags = function (t, e) {
            ...
            return (
                  ...
                  (u = t.line_indent_level)),
              {
                mode: e,
                parent: t,
                last_token: t ? t.last_token : new n(p.START_BLOCK, ''),
            ...
            (T.prototype.handle_whitespace_and_comments = function (t, e) {
              ...
              if (t.comments_before)
                for (var n = t.comments_before.next(); n; )
                  this.handle_whitespace_and_comments(n, e),
          ...
          (T.prototype.allow_wrap_or_preserved_newline = function (t, e) {
            (e = void 0 !== e && e),
              this._output.just_added_newline() ||
                ...
                (l(this._flags.last_token.text, h) || l(t.text, h)) &&
                  ((t =
                    (l(this._flags.last_token.text, h) && l(this._options.operator_position, b)) ||
                    l(t.text, h)),
                  (e = e && t)),
                e
            ...
            (T.prototype.start_of_statement = function (t) {
              return (
                !!(
                  ...
                  (!(this._flags.parent.mode === m && this._flags.mode === k) &&
                    f(this._flags.last_token, A) &&
                    !t.newlines) ||
                  (a(this._flags.last_token, 'else') && !(a(t, 'if') && !t.comments_before)) ||
                  (this._flags.last_token.type === p.END_EXPR &&
                    (this._previous_flags.mode === y || this._previous_flags.mode === x)) ||
                ...
                this.start_of_object_property() ||
                  this.allow_wrap_or_preserved_newline(t, f(t, ['do', 'for', 'if', 'while'])),
                !0)
              );
            }),
                ...
                this._flags.last_token.type === p.RESERVED
                  ...
                  ? ((this._output.space_before_token = !1),
                    ...
                    this._options.space_after_named_function &&
                      ...
                      f(e, ['async', 'function']) || ('*' === e.text && f(u, ['async', 'function']))
                        ? (this._output.space_before_token = !0)
                        : this._flags.mode === m
                        ? ('{' !== e.text &&
                            ',' !== e.text &&
                            ('*' !== e.text || ('{' !== u.text && ',' !== u.text))) ||
                          (this._output.space_before_token = !0)
                        : this._flags.parent &&
                  ...
                  ((this._flags.last_token.type === p.RESERVED &&
                    ...
                    ('*' === this._flags.last_token.text &&
                      (l(this._last_last_text, ['function', 'yield']) ||
                        (this._flags.mode === m && l(this._last_last_text, ['{', ',']))))) &&
              ...
              this.handle_whitespace_and_comments(t),
                this._flags.multiline_frame &&
                  this.allow_wrap_or_preserved_newline(
                    t,
                    ']' === t.text && R(this._flags.mode) && !this._options.keep_array_indentation
                  ),
            ...
            (T.prototype.handle_start_block = function (t) {
              ...
              var e = this._tokens.peek(),
                ...
                u =
                  ('switch' === this._flags.last_word && this._flags.last_token.type === p.END_EXPR
                    ...
                    ? this.set_mode(g)
                    : u &&
                      ((l(u.text, [':', ',']) && l(e.type, [p.STRING, p.WORD, p.RESERVED])) ||
                        (l(e.text, ['get', 'set', '...']) && l(u.type, [p.WORD, p.RESERVED])))
                    ? l(this._last_last_text, ['class', 'interface']) && !l(u.text, [':', ','])
                      ? this.set_mode(g)
                      : this.set_mode(m)
                    : (this._flags.last_token.type !== p.OPERATOR ||
                        '=>' !== this._flags.last_token.text) &&
                      (l(this._flags.last_token.type, [
                        ...
                        f(this._flags.last_token, ['return', 'throw', 'import', 'default']))
                    ? this.set_mode(m)
                    : this.set_mode(g),
                  this._flags.last_token &&
                    f(this._flags.last_token.previous, ['class', 'extends']) &&
              ...
              if (this._options.brace_preserve_inline) {
                ...
                do {
                  if ((n = this._tokens.peek((i += 1) - 1)).newlines) {
                    this._flags.inline_frame = !1;
                    break;
                  }
                } while (n.type !== p.EOF && (n.type !== p.END_BLOCK || n.opened !== t));
              }
              ...
              !this._flags.inline_frame
                ? this._flags.last_token.type !== p.OPERATOR &&
                  (e ||
                    this._flags.last_token.type === p.EQUALS ||
                    (f(this._flags.last_token, c) && 'else' !== this._flags.last_token.text))
                  ? (this._output.space_before_token = !0)
                  : this.print_newline(!1, !0)
                : (!R(this._previous_flags.mode) ||
                    (this._flags.last_token.type !== p.START_EXPR &&
                      this._flags.last_token.type !== p.COMMA) ||
                    ((this._flags.last_token.type !== p.COMMA && !this._options.space_in_paren) ||
                      (this._output.space_before_token = !0),
                    (this._flags.last_token.type === p.COMMA ||
                      (this._flags.last_token.type === p.START_EXPR && this._flags.inline_frame)) &&
                      (this.allow_wrap_or_preserved_newline(t),
                  ...
                  this._flags.last_token.type !== p.OPERATOR &&
                    this._flags.last_token.type !== p.START_EXPR &&
                    (this._flags.last_token.type !== p.START_BLOCK || this._flags.inline_frame
                      ? (this._output.space_before_token = !0)
                      : this.print_newline())),
                this.print_token(t),
                this.indent(),
            ...
            (T.prototype.handle_end_block = function (t) {
              for (this.handle_whitespace_and_comments(t); this._flags.mode === k; )
                this.restore_mode();
              ...
              this._flags.inline_frame && !e
                ...
                : e ||
                  (R(this._flags.mode) && this._options.keep_array_indentation
                ...
                this.start_of_statement(t)
                  ...
                  : !t.newlines ||
                    ...
                    (!this._options.preserve_newlines &&
                      f(this._flags.last_token, ['var', 'let', 'const', 'set', 'get']))
                  ? this.handle_whitespace_and_comments(t)
              ...
              if (
                ...
                return (
                  ...
                  this._flags.last_token.type === p.WORD
                    ...
                    ? (this._output.space_before_token = !0)
                    : (!this._flags.multiline_frame &&
                        (O(this._flags.mode) || R(this._flags.mode))) ||
                      this.print_newline(),
                  this.print_token(t),
              ...
              this._flags.last_token.type === p.END_BLOCK
                ...
                f(t, ['else', 'catch', 'finally'])
                  ...
                  ? f(this._flags.last_token, c) ||
                    ('declare' === this._flags.last_token.text && f(t, ['var', 'let', 'const']))
                    ? (this._output.space_before_token = !0)
                    : this._flags.last_token.type !== p.END_EXPR
                    ? (this._flags.last_token.type === p.START_EXPR &&
                        f(t, ['var', 'let', 'const'])) ||
            ...
            (T.prototype.handle_string = function (t) {
              (t.text.startsWith('`') &&
                0 === t.newlines &&
                '' === t.whitespace_before &&
                (')' === t.previous.text || this._flags.last_token.type === p.WORD)) ||
                (this.start_of_statement(t)
                  ? (this._output.space_before_token = !0)
                  : (this.handle_whitespace_and_comments(t),
                    this._flags.last_token.type === p.RESERVED ||
            ...
            (T.prototype.handle_comma = function (t) {
              this.handle_whitespace_and_comments(t, !0),
                ...
                this._flags.declaration_statement
                  ...
                  : this._flags.mode === m ||
                    (this._flags.mode === k && this._flags.parent.mode === m)
                  ? (this._flags.mode === k && this.restore_mode(),
              ...
              var e =
                ...
                u =
                  ...
                  (l(this._flags.last_token.type, [
                    ...
                    ',' === this._flags.last_token.text);
              if (
                (this.start_of_statement(t) || this.handle_whitespace_and_comments(t, !e),
                '*' === t.text && this._flags.last_token.type === p.DOT)
              )
                this.print_token(t);
                  ...
                  switch (this._options.operator_position) {
                    ...
                    case d.preserve_newline:
                      return (
                        ...
                        (i = !(this._output.just_added_newline() || o)),
                ...
                e
                  ? (this.allow_wrap_or_preserved_newline(t),
                    (i = !1),
                    (n = (_ = this._tokens.peek()) && l(_.type, [p.WORD, p.RESERVED])))
                  : '...' === t.text
                  ? (this.allow_wrap_or_preserved_newline(t),
                    (i = this._flags.last_token.type === p.START_BLOCK),
                    (n = !1))
                  : (l(t.text, ['--', '++', '!', '~']) || u) &&
                    ((this._flags.last_token.type !== p.COMMA &&
                      this._flags.last_token.type !== p.START_EXPR) ||
                    ...
                    !t.newlines ||
                      ...
                      ((e = f(this._flags.last_token, c) && t.newlines) &&
                        (this._previous_flags.if_block || this._previous_flags.else_block) &&
                        this.restore_mode(),
                      this.print_newline(e, !0)),
                    ';' === this._flags.last_token.text && O(this._flags.mode) && (i = !0),
                    this._flags.last_token.type === p.RESERVED
                      ? (i = !0)
                      : this._flags.last_token.type === p.END_EXPR
                      ? (i = !(
            ...
            (T.prototype.print_block_commment = function (t, e) {
              var u,
                ...
                _ = (function (t) {
                  for (
                    var e = [], u = (t = t.replace(o.allLineBreaks, '\n')).indexOf('\n');
                    -1 !== u;

                  )
                    e.push(t.substring(0, u)), (u = (t = t.substring(u + 1)).indexOf('\n'));
              ...
              if (
                ...
                for (
                  ...
                  i
                    ...
                    : (this._output.current_line.set_indent(-1), this._output.add_token(_[u])),
                    this.print_newline(!1, e);
        ...
        function (t) {
          ...
          (n.prototype.clone_empty = function () {
            ...
            (u.prototype.get_indent_size = function (t, e) {
              ...
              return (u = (u = t < 0 ? 0 : u) + t * this.__indent_size + (e = e || 0));
            }),
        ...
        function (t, e) {
          var u = '\\x24\\x30-\\x39\\x41-\\x5a\\x5f\\x61-\\x7a',
            ...
            _ = '(?:\\\\u[0-9a-fA-F]{4}|[\\x23\\x24\\x40\\x41-\\x5a\\x5f\\x61-\\x7a' + i + '])';
          (e.identifier = new RegExp(
            ...
            (e.identifierMatch = new RegExp('(?:\\\\u[0-9a-fA-F]{4}|[' + u + i + n + '])+'));
          (e.newline = /[\n\r\u2028\u2029]/),
        ...
        function (t, e, u) {
          var i = u(6).Options,
            n = ['before-newline', 'after-newline', 'preserve-newline'];
          function _(t) {
            i.call(this, t, 'js');
            ...
            (this.unindent_chained_methods = this._get_boolean('unindent_chained_methods')),
              ...
              (this.operator_position = this._get_selection('operator_position', n)),
        ...
        function (t) {
          ...
          (e.prototype._get_array = function (t, e) {
            ...
            (e.prototype._get_selection_list = function (t, e, u) {
              ...
              if (this._is_valid_selection(u, e)) return u;
              throw new Error(
                "Invalid Option Value: The option '" +
                  t +
        ...
        function (t, e, u) {
          ...
          var l,
            ...
            m = new RegExp('^(?:' + n.join('|') + ')$');
          ((p.prototype = new i())._is_comment = function (t) {
            ...
            (p.prototype._is_closing = function (t, e) {
              return (
                (t.type === f.END_BLOCK || t.type === f.END_EXPR) &&
                e &&
                ((']' === t.text && '[' === e.text) ||
                  (')' === t.text && '(' === e.text) ||
                  ('}' === t.text && '{' === e.text))
            ...
            (p.prototype._read_word = function (t) {
              ...
              return '' !== e
                ? ((e = e.replace(r.allLineBreaks, '\n')),
                  t.type !== f.DOT &&
                  (t.type !== f.RESERVED || ('set' !== t.text && 'get' !== t.text)) &&
                  m.test(e)
            ...
            (p.prototype._read_punctuation = function () {
              ...
              if ('' !== t)
                return '=' === t
                  ? this._create_token(f.EQUALS, t)
                  : '?.' === t
                  ? this._create_token(f.DOT, t)
                  : this._create_token(f.OPERATOR, t);
            }),
            (p.prototype._read_non_javascript = function (t) {
              var e = '';
              if ('#' === t) {
                if (this._is_first_token() && (e = this.__patterns.shebang.read()))
                  return this._create_token(f.UNKNOWN, e.trim() + '\n');
                ...
                if (this._input.hasNext() && this._input.testChar(b)) {
                  for (
                    ;
                    (u += t = this._input.next()), this._input.hasNext() && '#' !== t && '=' !== t;
              ...
              } else if (l && '-' === t && (e = this.__patterns.html_comment_end.read()))
                return (l = !1), this._create_token(f.COMMENT, e);
              return null;
            }),
                ...
                '/' === t &&
                  ...
                  '*' === this._input.peek(1)
                    ? ((t = this.__patterns.block_comment.read()),
                      (e = c.get_directives(t)) &&
                        'start' === e.ignore &&
                        (t += c.readIgnored(this._input)),
                      (t = t.replace(r.allLineBreaks, '\n')),
                      ((u = this._create_token(f.BLOCK_COMMENT, t)).directives = e))
                    : '/' === this._input.peek(1) &&
                      ((t = this.__patterns.comment.read()),
                      (u = this._create_token(f.COMMENT, t)))),
                u
              );
            }),
                    ...
                    (e = (function (t) {
                      ...
                      for (; i.hasNext(); )
                        if (
                          ...
                          if (!n) return t;
                          if (126 < (u = parseInt(n[1], 16)) && u <= 255 && 0 === n[0].indexOf('x'))
                            return t;
                          e +=
                            0 <= u && u < 32
                              ? '\\' + n[0]
            ...
            (p.prototype._allow_regexp_or_xml = function (t) {
              return (
                ...
                (t.type === f.END_EXPR &&
                  ')' === t.text &&
                  t.opened.previous.type === f.RESERVED &&
            ...
            (p.prototype._read_regexp = function (t, e) {
              if ('/' === t && this._allow_regexp_or_xml(e)) {
                for (
                  var u = this._input.next(), i = !1, n = !1;
                  this._input.hasNext() &&
                  (i || n || this._input.peek() !== t) &&
                  ...
                  (u += this._input.peek()),
                    i
                      ...
                      : ((i = '\\' === this._input.peek()),
                        '[' === this._input.peek()
                          ? (n = !0)
                          : ']' === this._input.peek() && (n = !1)),
                    this._input.next();
                return (
                  this._input.peek() === t &&
                    (u = (u += this._input.next()) + this._input.read(r.identifier)),
                  this._create_token(f.STRING, u)
                );
              }
              return null;
            }),
                ...
                if (i) {
                  for (
                    ...
                    var a = !!i[1],
                      o = i[2];
                    if (
                      (!(!!i[i.length - 1] || '![CDATA[' === o.slice(0, 8)) &&
                        (o === n || (_ && o.replace(/^{\s+/, '{').replace(/\s+}$/, '}'))) &&
                        (a ? --s : ++s),
                      (u += i[0]),
                      s <= 0)
                    )
            ...
            (p.prototype._read_string_recursive = function (t, e, u) {
              "'" === t
                ? (n = this.__patterns.single_quote)
                : '"' === t
                ? (n = this.__patterns.double_quote)
                : '`' === t
                ? (n = this.__patterns.template_text)
                : '}' === t && (n = this.__patterns.template_expression);
              for (var i, n, _ = n.read(), s = ''; this._input.hasNext(); ) {
        ...
        function (t) {
          ...
          (e.prototype.restart = function () {
            ...
            (e.prototype.__match = function (t, e) {
              ...
              return !u || (i && t.sticky) || (u.index !== e && (u = null)), u;
            }),
            ...
            (e.prototype.read = function (t, e, u) {
              var i,
                n = '';
              return (
                t && (i = this.match(t)) && (n += i[0]),
                !e || (!i && t) || (n += this.readUntil(e, u)),
                n
              );
            }),
            (e.prototype.readUntil = function (t, e) {
              var u = this.__position,
                t = ((t.lastIndex = this.__position), t.exec(this.__input));
              return (
                t ? ((u = t.index), e && (u += t[0].length)) : (u = this.__input_length),
                (e = this.__input.substring(this.__position, u)),
                (this.__position = u),
                e
              );
            }),
        ...
        function (t, e, u) {
          ...
          (i.prototype.tokenize = function () {
              ...
              n.isEmpty() || ((t.comments_before = n), (n = new s())),
                ...
                this._is_opening(t)
                  ...
                  : u &&
                    ...
                    (((t.opened = u).closed = t), (u = i.pop()), (t.parent = u)),
                ((t.previous = e).next = t),
                this.__tokens.add(t),
                (e = t);
            }
            ...
            (i.prototype._get_next_token = function (t, e) {
              ...
              return u ? this._create_token(o.RAW, u) : this._create_token(o.EOF, '');
            }),
        ...
        function (t, e, u) {
          ...
          ((n.prototype = new i()).__set_whitespace_patterns = function (t, e) {
            ...
            (n.prototype.__split = function (t, e) {
              for (var u = (t.lastIndex = 0), i = [], n = t.exec(e); n; )
                i.push(e.substring(u, n.index)), (u = n.index + n[0].length), (n = t.exec(e));
        ...
        function (t) {
          ...
          (e.prototype.get_directives = function (t) {
            ...
            for (
              var e = {},
                u = ((this.__directive_pattern.lastIndex = 0), this.__directive_pattern.exec(t));
              u;
        ...
        function (t, e, u) {
          var i = u(12).Pattern,
            n = { django: !1, erb: !1, handlebars: !1, php: !1, smarty: !1 };
          function _(t, e) {
            i.call(this, t, e),
              (this.__template_pattern = null),
              (this._disabled = Object.assign({}, n)),
              (this._excluded = Object.assign({}, n)),
              e &&
          ...
          ((_.prototype = new i())._create = function () {
            ...
            (_.prototype.read_options = function (t) {
              var e,
                u = this._create();
              for (e in n) u._disabled[e] = -1 === t.templating.indexOf(e);
              return u._update(), u;
            }),
    ...
    var t = (function t(e) {
      ...
      u = n[e] = { exports: {} };
      return i[e](u, u.exports, t), u.exports;
    })(0);
    e = t;
  })();
  var e,
