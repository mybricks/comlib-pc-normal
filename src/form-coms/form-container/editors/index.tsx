...
export default {
  ...
  '@parentUpdated'(curEditor, { schema }) {
    ...
    //     slot.get('content').addCom('amc.normal-h5.form-text', false, { deletable: true, movable: true });
    //   }
    // }
  ...
  // formItemEditor为:child(amc.normal-h5.form-container/form-item) 部分
  ...formItemEditor,
  // additionFormItemEditor为:child(amc.normal-h5.form-container/form-addition-container) 部分
