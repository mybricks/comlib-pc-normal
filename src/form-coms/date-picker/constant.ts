      ...
      items: {
        ...
        properties: {
          value: {
            title: '比较值',
            description:
              "可以是字符或者数组，例如 `TODAY`、`2024-07-17` 可用在>=; ['2024-07-16', '2024-07-28']可用在in、between；'Sat'、'Mon',  用在equal场景",
            type: 'any'
          },
          op: {
            type: 'enum',
            title: '比较符号',
            description:
              "比较操作，例如，>、>=、<= 具体日期，以及in、notIn区间包含关系；equal、notEqual特定日期（周六日、季度一二）；between 日期区间；complex 用于复杂场景，value可取{relation: '&&', rules: []}",
            items: [
              {
                type: 'string',
                value: '>'
