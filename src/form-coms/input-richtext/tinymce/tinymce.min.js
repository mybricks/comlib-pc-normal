...
!(function () {
  ...
  var Jr,
    ...
    xo = function (e) {
      var t = e.container();
      return (
        !!Mn(t) && (t.data.charAt(e.offset()) === mo || (e.isAtStart() && bo(t.previousSibling)))
      );
    },
    So = function (e) {
      var t = e.container();
      return (
        !!Mn(t) && (t.data.charAt(e.offset() - 1) === mo || (e.isAtEnd() && bo(t.nextSibling)))
      );
    },
    No = function (e, t, n) {
      var r,
    ...
    Ho = function (e, t) {
      return (
        (Io(e) && !1 === ((o = t), Mn((r = e)) && zo(r.data) && !1 === jo(r, o))) ||
        (Rn((n = e)) &&
          'A' === n.nodeName &&
          !n.hasAttribute('href') &&
    ...
    Go = function (e, t, n) {
      ...
      return (
        !Rn(t) ||
          (1 === (o = t.childNodes).length && Xo(o[0]) && t.parentNode.insertBefore(o[0], t)),
        zn((a = t)) ||
          Un(a) ||
          Ho(t, r) ||
        ...
        p = function (e, t, n) {
          ...
          return (
            r
              ...
              : (r = fi[e]) ||
                ((r = mi(t, ' ', mi(t.toUpperCase(), ' '))), (r = gi(r, n)), (fi[e] = r)),
            r
          );
        },
        g =
  ...
  (au.fn = au.prototype =
    {
      ...
      add: function (e, t) {
        ...
        if (!1 !== t)
          for (
            n = gu.unique(this.toArray().concat(gu.makeArray(e))), this.length = n.length, r = 0;
            r < n.length;
            r++
          )
            this[r] = n[r];
    ...
    function (r, o) {
      au.fn[r] = function (t) {
        ...
        this.each(function () {
          ...
          1 < this.length &&
            (Ka[r] || (n = gu.unique(n)), 0 === r.indexOf('parents') && (n = n.reverse()));
        var e = gu(n);
    ...
    xu = function (a, u) {
      ...
      var n,
        ...
        H = function (e, t, n, r) {
          ...
          return (
            !u.collect || (e !== a && e !== c) || m.push([e, t, n, r]), h.bind(e, t, n, r || $)
          );
        },
        V = function (e, t, n) {
          if (_t.isArray(e)) {
          ...
          isEmpty: function (e, t) {
            ...
            if ((e = e.firstChild)) {
              ...
              do {
                ...
                if (3 === n && e.parentNode && a[e.parentNode.nodeName] && zo(e.nodeValue))
                  return !1;
                e = i.next();
              } while (e);
            }
  ...
  var Pu = function (n, r) {
    ...
    Xu = function (r, e) {
      var t = r.selection.getRng(),
        ...
        s = function (e, t) {
          return (
            (n = t),
            (r = e.dom) && r.hasAttribute && r.hasAttribute(n) ? U.some(Jn(e, t)) : U.none()
          );
          var n, r;
        };
    ...
    es = function (e, t) {
      var n,
        ...
        a =
          ((n = t), ((r = (o || document).createElement('div')).innerHTML = n), Jt(Rt.fromDom(r)));
      mn(i, a), pn(e), dn(e, i);
    },
    ts = function (e, t) {
    ...
    Ls = function (e) {
      var t,
        ...
        i = function (e, t) {
          ...
          if (t < e.data.length) {
            ...
            if (vs(e.data[t - 1]) && (n.setStart(e, t), n.setEnd(e, t + 1), !Ds(n)))
              return o(Ps(Bs(n), !1)), r;
          }
          0 < t && (n.setStart(e, t - 1), n.setEnd(e, t), Ds(n) || o(Ps(Bs(n), !1))),
            t < e.data.length && (n.setStart(e, t), n.setEnd(e, t + 1), Ds(n) || o(Ps(Bs(n), !0)));
        };
      ...
      if (ys(e.container()))
        if (e.isAtEnd())
          ...
          if (((n = _s(e.container(), e.offset())), Ns(n) && i(n, 0), xs(n) && e.isAtEnd()))
            return o(Ps(Bs(n), !1)), r;
  ...
  var Ms,
    ...
    Tc = function (e, t) {
      return Nc(e) && t.container() === e
        ? ((r = t),
          ...
          0 < (o.text + i.text).length ? (_c(n), Is(n, r.offset() - o.count)) : r)
        : Ac(e, t);
      var n, r, o, i;
    },
    Dc = function (e, t) {
    ...
    Fc = function (e, i, a, t) {
      var n,
        ...
        l = function () {
          !(function (e) {
            for (
              var t = qu(Rt.fromDom(e), '*[contentEditable=false],video,audio,embed,object'), n = 0;
              n < t.length;
              n++
            ) {
              var r,
        ...
        f = function () {
          n = Wr.setInterval(function () {
            t()
              ? gu('div.mce-visual-caret', i).toggleClass('mce-visual-caret-hidden')
              : gu('div.mce-visual-caret', i).addClass('mce-visual-caret-hidden');
          }, 500);
        };
      return {
        show: function (t, e) {
          ...
          var o = gu('<div class="mce-visual-caret" data-mce-bogus="all"></div>')
            .css(n)
            .appendTo(i)[0];
          return (
    ...
    ol = function (e, t, n) {
      ...
      if (yo(u)) {
        if (
          (Kc(u) || (u = u.parentNode),
          'before' === (o = u.getAttribute('data-mce-caret')) && ((r = u.nextSibling), jc(r)))
        )
          return nl(r);
  ...
  var ll,
    ...
    Sl = function (e, t, n) {
      ...
      if (t.isEqual(Is.after(n)) && n.lastChild) {
        if (((a = Is.after(n.lastChild)), e < 0 && yl(n.lastChild) && hl(n.lastChild)))
    ...
    Al = function (e, t, n) {
      return e
        ? !_l(t, n) && ((r = t), !(!Is.isTextPosition(r) && jn(r.getNode()))) && kl(t) && El(n)
        : !_l(n, t) && El(t) && kl(n);
      var r;
    },
    Rl = function (e, t, n) {
    ...
    Ol = function (e, t) {
      ...
      return Mn(u)
        ...
        ? Io(u)
          ...
          : ((r = t), (o = u), (i = (n = e) ? Is.before(o) : Is.after(o)), Rl(n, r, i))
        : U.none();
    },
    Bl = N(Rl, !0),
    Pl = N(Rl, !1),
      ...
      if (
        ...
        for (
          u < (i = s.childNodes).length
            ...
            : ((s = i[i.length - 1]), (r = new Yr(s, e.getParent(s, e.isBlock))).next(!0)),
            o = r.current();
          o;
          o = r.next()
        )
    ...
    _f = function (e, t, n, r, o) {
      ...
      for (;;) {
        ...
        for (i = u[s]; i; i = i[s]) {
          ...
          if (
            !gf(i) &&
            (!jn((a = i)) || !a.getAttribute('data-mce-bogus') || a.nextSibling) &&
            !vf(i, l)
          )
            return u;
        }
    ...
    Rf = function (e, t, n, r) {
      ...
      return (
        ...
        Rn(a) &&
          a.hasChildNodes() &&
          ((a = gs(a, t.collapsed ? u : u - 1)), Mn(a) && (u = a.nodeValue.length)),
        (o = bf(s, o)),
        (a = bf(s, a)),
        Af(o) &&
        ...
        (n[0].inline || n[0].block_expand) &&
          ...
          (n[0].inline && Mn(a) && u !== a.nodeValue.length) || (a = _f(s, n, a, u, !1))),
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
          ((o = Nf(s, n, t, o, 'previousSibling')), (a = Nf(s, n, t, a, 'nextSibling'))),
        (n[0].block || n[0].selector) &&
          ((o = Ef(e, n, o, 'previousSibling')),
          (a = Ef(e, n, a, 'nextSibling')),
          n[0].block &&
            (s.isBlock(o) || (o = _f(s, n, o, i, !0)), s.isBlock(a) || (a = _f(s, n, a, u, !1)))),
  ...
  var Jf = function (e, t) {
    ...
    ld = function (e, t, n, r) {
      ...
      if (
        (Rn(l) && f > l.childNodes.length - 1 && (p = !1), Un(l) && ((l = s), (f = 0)), l === s)
      ) {
      ...
      return (
        t === r && Mn(t)
          ? 0 < n &&
            ...
            n < o
              ? ((t = r = dd(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0))
              : (o = 0))
          : (Mn(t) && 0 < n && n < t.nodeValue.length && ((t = dd(t, n)), (n = 0)),
            Mn(r) &&
              0 < o &&
  ...
  var gd,
    ...
    Cd =
      ...
      }),
      {
        set: function (e, t) {
          if (!O(t) && !t.match(/^[0-9]+$/))
            throw new Error(gd + '.set accepts only positive integer values. Value was ' + t);
          var n = e.dom;
    ...
    Hd = function (e) {
      return (
        void 0 === e && (e = Rt.fromDom(document)), U.from(e.dom.activeElement).map(Rt.fromDom)
      );
    },
    Vd = function (e, t, n, r) {
    ...
    dm = function (t, e) {
      return (
        (n = e).collapsed ? U.from(gs(n.startContainer, n.startOffset)).map(Rt.fromDom) : U.none()
      ).bind(function (e) {
        ...
        n = function (f, e) {
          ...
          for (
            ...
            if ((x < t.index && T(E(w.substr(x, t.index - x))), (i = t[7])))
              ...
              u ||
                (p && p.indexOf('/') === p.length - 1 ? c && Q(i) : S.push({ name: i, valid: c }));
            } else if ((i = t[1])) D(i);
            else if ((i = t[2])) {
              if (
                !(
  ...
  var Lm,
      ...
      return U.some(e)
        ...
        .bind(function (e) {
          ...
          !(!Lp(u, 0) || Pp(i, s) || ((a.data = ' ' + u.slice(1)), 0)) ||
            ...
            (r = (n = c).data),
            (o = Is(n, r.length - 1)),
            !(!Lp(r, r.length - 1) || Pp(t, o) || ((n.data = r.slice(0, -1) + ' '), 0))))
            ? U.some(e)
            : U.none();
        });
    },
    ...
    Vp = function (e, t, n, r) {
      ...
      var o = Xe(e.data).length,
        ...
        a = r ? t : e;
      return (
        r ? i.appendData(a.data) : i.insertData(0, a.data), gn(Rt.fromDom(a)), n && jp(i, o), i
      );
    },
    qp = function (e, t) {
      return (
        ...
        (o = (n = t).container()),
        (i = n.offset()),
        !1 === Is.isTextPosition(n) && o === r.parentNode && i > Is.before(r).offset()
    ...
    $p = function (e) {
      return Io(e.previousSibling)
        ? U.some(((t = e.previousSibling), Mn(t) ? Is(t, t.data.length) : Is.after(t)))
        : e.previousSibling
    ...
    pg = function (e, t) {
      var n,
        ...
        s =
          ((o = u), (i = rg((r = t).startContainer, o)), (a = rg(r.endContainer, o)), as(i, a, tg));
      return dg(s, t, u)
        .map(function (e) {
    ...
    Ug = function (e) {
      ...
      (r = t),
        (o = n),
        null !== (i = a) && i === r.getParent(o.endContainer, Fg) && Ff(Rt.fromDom(i), o)
          ? vg(e, n, Rt.fromDom(a))
    ...
    zg = function (e, t, n) {
      ...
      if ((y = e.fire('BeforeSetContent', y)).isDefaultPrevented())
        ...
        if (!0 === n.paste && Dg(e.schema, F) && Pg(m, r))
          return (a = Mg(h, m, d.getRng(), F)), d.setRng(a), void e.fire('SetContent', y);
        if (
          (!(function (e) {
            ...
            : ((t = u),
              ...
              0 === (r = s).length || /^\s+$/.test(r)
                ? ((a = '<br data-mce-bogus="1">'),
                  ...
                  (r =
                    (i = lc(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase())
        ...
        if ('undefined' == typeof c.length) {
          for (a in c)
            if (c.hasOwnProperty(a)) {
              if (((u = 'attributes' === r ? e.getAttrib(t, a) : sf(e, t, a)), o && !u && !n.exact))
                return;
    ...
    eh = function (e, t, n, r, o) {
      ...
      if (c && t)
        for (a = 0; a < c.length; a++)
          if (
            ((i = c[a]),
            Qg(e.dom, t, i) && Zg(l, t, i, 'attributes', o, r) && Zg(l, t, i, 'styles', o, r))
          ) {
            if ((s = i.classes))
    ...
    sh = function (e) {
      ...
      return (
        Gn(t, { id: ih, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret' }),
    ...
    Mh = function (e, r, o, t, i) {
      ...
      if ('all' !== r.remove) {
        Rh(r.styles, function (e, t) {
          (e = uf(l, of(e, o), t + '')),
            O(t) && ((t = e), (i = null)),
            (!r.remove_similar && i && !Th(sf(l, i, t), e)) || l.setStyle(y, t, ''),
            (n = !0);
        }),
          n &&
            '' === l.getAttrib(y, 'style') &&
                ...
                ((m.list_block && Th(d, m.list_block)) ||
                  Y(ie(d.childNodes), function (e) {
                    nf(f, v, e.nodeName.toLowerCase())
                      ? p
                        ? p.appendChild(e)
                        : ((p = Ph(h, e, v)), h.setAttribs(p, f.settings.forced_root_block_attrs))
                      : (p = 0);
                  }))
              : h.isBlock(d) &&
                !h.isBlock(g) &&
                ...
                Ih(h, d, !0) || Ih(h, d.lastChild, !1, !0) || d.appendChild(h.create('br')))),
    ...
    Uh = function (e, t, n, r, o, i, a, u) {
      ...
      if (n) {
        ...
        !i || (a.mixed && f.isBlock(n)) || (r = f.split(n, r)),
          c && (o.parentNode.insertBefore(c, o), l.appendChild(o), a.inline && Sh(f, a, 0, c));
      }
      return r;
    },
          ...
          if (m.split) {
            if (((r = md(r)), (t = Oh(s, r, !0)) !== (n = Oh(s, r)))) {
              if (((t = Bh(t, !0)), (n = Bh(n, !1)), Dh(a, t, n))) {
                ...
                return (
                  u(Lh(a, o, !0, 'span', { id: '_start', 'data-mce-type': 'bookmark' })), void g(!0)
                );
              }
              if (Dh(a, n, t)) {
                o = U.from(n.lastChild).getOr(n);
                return (
                  u(Lh(a, o, !1, 'span', { id: '_end', 'data-mce-type': 'bookmark' })), void g(!1)
                );
              }
              (t = Ph(a, t, 'span', { id: '_start', 'data-mce-type': 'bookmark' })),
                (n = Ph(a, n, 'span', { id: '_end', 'data-mce-type': 'bookmark' }));
              var i = a.createRng();
              i.setStartAfter(t),
                i.setEndBefore(n),
                Df(a, i, function (e) {
          ...
          return (
            ...
            (Vh(e, function (e) {
              if (!('collapsed' in e && e.collapsed !== i))
                return a.is(t, e.selector) && !Fl(t) ? (T(t, e), !(n = !0)) : void 0;
            }),
            n)
          );
        },
                ...
                w = function (e) {
                  ...
                  return (
                    Vh(e.childNodes, function (e) {
                      if ((t = e) && 1 === t.nodeType && !Xl(t) && !Fl(t) && !Bn(t))
                        return (n = e), !1;
                      var t;
                    }),
                    n
      ...
      if ('false' !== a.getContentEditable(u.getNode())) {
        R &&
          (r
            ? Ql(r)
              ? m(A, r) ||
                ((e = a.createRng()).setStartBefore(r), e.setEndAfter(r), s(a, Rf(E, e, A), 0, !0))
              : s(a, r, 0, !0)
            : i && pf(R) && !Lf(E).length
            ? (function (e, t, n) {
                var r,
      ...
      return (
        Y(qu(e, 'tr'), function (n, r) {
          Y(qu(n, 'td,th'), function (e, t) {
            !(function (e, t, n, r, o) {
              for (
                var i = Qh(o, 'rowspan'), a = Qh(o, 'colspan'), u = e.rows, s = n;
                s < n + i;
                s++
              ) {
                u[s] || (u[s] = Jh(rs(r), []));
    ...
    pv = function (e, t, n) {
      ...
      var r,
        ...
        l =
          ...
          (s = Nm(r, Of(u))),
          (c = o.contextual ? lv(Rt.fromDom(r.getBody()), s).dom : i.cloneContents()) &&
            a.appendChild(c),
      ...
      return {
        undoManager: {
          ...
          hasUndo: function (e, t) {
            return (
              (n = f), (r = e), 0 < t.get() || (r.typing && r.data[0] && !Nv(Cv(n), r.data[0]))
            );
            var n, r;
          },
        ...
        formatter: {
          ...
          toggle: function (e, t, n) {
            return (
              ...
              void (!th(r, o, i, a) || ('toggle' in u[0] && !u[0].toggle) ? $h : zh)(r, o, i, a)
            );
            var r, o, i, a, u;
          },
        ...
        return (
          ...
          t.filter(zt).map(function (e) {
            return (
              ...
              void (r ? (Vp(o, i, !1, !r), n.setStart(i, a)) : (Vp(i, o, !1, !r), n.setEnd(i, a)))
            );
            var t, n, r, o, i, a;
          })
        );
  ...
  var Fv,
            ...
            for (var t, n, r, o = e.length; o--; ) {
              ('ul' !== (r = (n = e[o]).parent).name && 'ol' !== r.name) ||
                (n.prev && 'li' === n.prev.name
                  ? n.prev.append(n)
                  : ((t = new Am('li', 1)).attr('style', 'list-style-type: none'), n.wrap(t)));
            }
          }),
        g.validate &&
          h.getValidClasses() &&
              ...
              k = Pm(
                {
                  ...
                  start: function (e, t, n) {
                    ...
                    if (a) {
                      ...
                      if ((S && y[e] && (S = !1), a.removeEmpty && ey(R, m, y, c)))
                        return (
                          (o = c.parent), d[c.name] ? c.empty().remove() : c.unwrap(), void (c = o)
                        );
                      a.paddEmpty &&
                        ((Zv((i = c), '#text') && i.firstChild.value === fo) || ey(R, m, y, c)) &&
                        Qv(A, u, d, c),
                        (c = c.parent);
                    }
                  }
                          ...
                          if (p[t.name] && 'li' === t.parent.name) {
                            ...
                            if (n && 1 < r.length) {
                              ...
                              ey(R, d, m, o)
                                ...
                                (n = r[0]),
                                (ey(R, d, m, n) || Zv(n, 'br')) && n.empty().remove();
                            } else if (t.parent) {
                              if ('li' === t.name) {
    ...
    Dy = function (e, t, n, r) {
      return e && ((a = i = 'mobile'), (u = (o = t).sections()), Ry(o, i) && u[i].theme === a)
        ? H(r, N(M, Ey))
        : e && Ry(t, 'mobile')
        ? r
        : n;
        ...
        d = e
          ? {
              mobile:
                ((i = o.mobile || {}),
                (a = t),
                (u = { resize: !1, toolbar_mode: Ty(i, 'scrolling'), toolbar_sticky: !1 }),
        ...
        p = _t.extend(
            ...
            : {}),
          {
            ...
            external_plugins:
              ...
              s && s.external_plugins ? _t.extend({}, s.external_plugins, l) : l)
          }
        );
      return Oy(e, m, r, p);
    },
    ...
    qy = function (e, t, n) {
      ...
      return (
        (l = h.x), (f = h.y), (d = zy((c = g))), (m = jy(c)), 0 <= l && 0 <= f && l <= d && f <= m
      );
    },
    $y = function (e) {
      var t,
  ...
  var Yy,
    ...
    ob = function (e) {
      return ib(
        ...
        K(n) ? z(n.split(','), We) : _(n) ? n : !1 === n || t.inline ? [] : ['default'])
      );
      var t, n;
    },
    ib = function (t, e) {
    ...
    ab = function (e) {
      var t;
      // 不再请求content_css资源，该请求会根据相对路径请求，本地化已注入相应资源
      // e.contentCSS = e.contentCSS.concat(ob(e), ib((t = e), vc(t)));
      e.contentCSS = e.contentCSS.concat(ib((t = e), vc(t)));
    },
    ub = function () {
      var n = {},
        r = function (e, t) {
                          ...
                          e.status && s.getParam('images_replace_blob_uris', !0, 'boolean')
                            ...
                            : e.error &&
                              (e.error.options.remove &&
                                (p(i.getAttribute('src'), xt.transparentSrc), a.push(i)),
                              (n = s),
                              (r = e.error.message),
                              Zy(n, Ou.translate(['Failed to upload image: {0}', r]))),
          ...
          (t = e.replace(/(?:([#\.]|::?)([\w\-]+)|(\[)([^\]]+)\]?)/g, function (e, t, n, r, o) {
            switch (t) {
              ...
              case '.':
                ...
                break;
              case ':':
                -1 !== _t.inArray('checked disabled enabled read-only required'.split(' '), n) &&
                  (a.attrs[n] = n);
            }
            var i;
            return (
          ...
          if (
            !(
              ('background-color' === e &&
                ...
                ((t = hb.getStyle(n.getBody(), e, !0)), '#ffffff' === hb.toHex(t).toLowerCase())) ||
        ...
        l = function (e, t) {
          ...
          !(function (e) {
            if (Eb(e)) {
              var t = e.keyCode;
              return (
                !kb(e) && (ed.metaKeyPressed(e) || e.altKey || (112 <= t && t <= 123) || M(Sb, t))
              );
            }
            return !1;
          })(e) &&
        ...
        e
          ? function (e) {
              if (bC(e.previousSibling))
                return wC(e.previousSibling) || e.previousSibling.appendData(mo), e.previousSibling;
          ...
          : function (e) {
              if (bC(e.nextSibling))
                return CC(e.nextSibling) || e.nextSibling.insertData(0, mo), e.nextSibling;
    ...
    qC = function (a, e, u, t, n, s) {
      return as(Db(e, u, t), Db(e, u, n), function (e, t) {
        return e !== t && ((r = t), (o = Jc(e, (n = u))), (i = Jc(r, n)), o && o === i)
          ? TC.after(a ? e : t)
          : s;
        var n, r, o, i;
      }).getOr(s);
    ...
    YC = function (e, t) {
      ...
      return (
        ...
        (e && xo(r) ? XC(!0, t.selection, r) : !(e || !So(r)) && XC(!1, t.selection, r))
      );
    },
    GC = function (e, t) {
      ...
      return (
        d.on('NodeChange', function (e) {
          ...
          !wc(d) ||
            ...
            (s = e.parents),
            (c = z(
              qu(Rt.fromDom(u.getRoot()), '*[data-mce-selected="inline-boundary"]'),
              function (e) {
                return e.dom;
              }
            )),
      ...
      e.queryCommandState('InsertUnorderedList') ||
        ...
        Y(bw(e), function (e) {
          ...
          (t = l),
            ...
            (s = hw(r, Rt.fromDom(a))),
            'outdent' === n
              ? ((u = Math.max(0, gw(a.style[s]) - o)), t.setStyle(a, s, u ? u + i : ''))
        ...
        if (
          ...
          for (
            ...
            if (((g = u), Mn((h = s)) || (Rn(h) && !kw(g, h) && !Xl(h)))) {
              if (
                (function (e, t) {
                  if (Mn(t)) {
                    ...
                    if (/^\s+$/.test(t.nodeValue) && (!t.nextSibling || kw(e, t.nextSibling)))
                      return !0;
                  }
                  return !1;
                })(u, s)
              ...
              t || ((t = o.create(l, fc(e))), s.parentNode.insertBefore(t, s), (r = !0)),
                (s = (n = s).nextSibling),
                t.appendChild(n);
    ...
    Aw = function (e, t) {
      ...
      t.hasAttribute('data-mce-caret') &&
        (_o(t), (n = e).selection.setRng(n.selection.getRng()), e.selection.scrollIntoView(t));
    },
    Rw = function (e, t) {
      var n,
        r =
      ...
      for (
        ...
        if (jn(o.getNode(!1)))
          return t === Ms.Forwards
            ? { positions: Ow(t, d).concat([o]), breakType: Yy.Br, breakAt: U.some(o) }
  ...
  var Vw = function (o, i, a, e, u, t) {
        ...
        if (
          (u = ex(
            (function (e, r, t) {
              ...
              return (
                o.push(r), tx(Tw.Up, e, N(n, fs), r.node, t), tx(Tw.Down, e, N(n, ds), r.node, t), o
              );
            })(e, u, s),
            t
          )) &&
    ...
    Lx = function (e, t, n) {
      ...
      return ((a = u).breakType === Yy.Wrap && 0 === a.positions.length) ||
        (!jn(n.getNode()) && (i = u).breakType === Yy.Br && 1 === i.positions.length)
        ? ((r = e),
          (o = t),
    ...
    aS = function (a, e) {
      var t,
        ...
        h = function (e) {
          ...
          var o = new Yr(u, s);
          for (
            Mn(u) && (e && 0 === r ? o.prev() : e || r !== u.nodeValue.length || o.next());
            (t = o.current());
        ...
        v = function () {
          (n = /^(H[1-6]|PRE|FIGURE)$/.test(c) && 'HGROUP' !== C ? g(N) : g()),
            a.getParam('end_container_on_empty_block', !1) && nS(f, o) && f.isEmpty(s)
              ? (n = f.split(o, s))
              : f.insertAfter(n, s),
            Kx(a, n);
        };
          ...
          (u = (function (e, t, n, r, o) {
            ...
            if (!p || !nS(d, p)) {
              if (
                ...
                return (
                  (i = d.create(f)), iS(e, i), p.appendChild(i), n.setStart(i, 0), n.setEnd(i, 0), i
                );
              for (u = r; u.parentNode !== p; ) u = u.parentNode;
              for (; u && !d.isBlock(u); ) u = (a = u).previousSibling;
              if (a && e.schema.isValidChild(c, f.toLowerCase())) {
                for (
                  i = d.create(f), iS(e, i), a.parentNode.insertBefore(i, a), u = a;
                  u && !d.isBlock(u);
            ...
            yo(s)
              ...
              : ((S = (x = p).cloneRange()).setStart(
                ...
                (function (e) {
                  for (
                    ;
                    Mn(e) && (e.nodeValue = e.nodeValue.replace(/^[\r\n]+/, '')),
                      (e = e.firstChild);
  ...
  var VS = function (e) {
          ...
          ((a = function (e) {
            ...
            e.isDefaultPrevented() ||
              ((t = e.dataTransfer) &&
                ...
                (e.preventDefault(),
                'drop' === e.type && Zy(i, 'Dropped file type is not supported')));
          }),
          (u = function (e) {
            cm(i, e.target) && a(e);
          }),
            ...
            var a = function (e) {
              ...
              i = function (e, t) {
                var n,
                  ...
                  i = l.getParent(t, f);
                return (
                  !(!o || e === i || !l.isChildOf(o, i) || !1 !== oN(iN(u, o))) ||
    ...
    yN = function (e) {
      ...
      var n = sc(e, 'body_id', 'myTinymce'),
        r = sc(e, 'body_class', '');
      return (
        cc(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + cc(e) + '" />'),
        (t +=
          '</head><body id="' +
          n +
      ...
      var s = (function (e, t) {
        if (document.domain !== window.location.hostname && xt.browser.isIE()) {
          ...
          var r =
            ...
            document.domain +
            '";var ed = window.parent.myTinymce.get("' +
            e.id +
      ...
      e.fire('ScriptsLoaded'),
        ...
        K(u)
          ? ((i.settings.theme = xN(u)),
            ...
            i.theme.init &&
              i.theme.init(i, Xy.urls[u] || i.documentBaseUrl.replace(/\/$/, ''), i.$))
          : (i.theme = {}),
        (s = e),
        (c = []),
        ...
        ? t.getElement() &&
          ...
          (a = t.getElement().form || _N.getParent(e, 'form')) &&
            ...
            t.getParam('hidden_input') &&
              !In(t.getElement()) &&
              (_N.insertAfter(_N.create('input', { type: 'hidden', name: e }), e),
              (t.hasHiddenInput = !0)),
  ...
  var uE,
      ...
      toggleNativeEvent: function (e, t) {
        ...
        'focus' !== e &&
          ...
          (t
            ...
            : n.initialized && (n.dom.unbind(fE(n, e), e, n.delegates[e]), delete n.delegates[e]));
      },
    ...
    xE = function (e) {
      ...
      yE(bE(e.toLowerCase(), '+'), function (e) {
        e in wE
          ...
          : ((n.charCode = e.charCodeAt(0)), (n.keyCode = CE[e] || e.toUpperCase().charCodeAt(0)));
      });
      var r = [n.keyCode];
    ...
    SE =
      ...
      (NE.prototype.createShortcut = function (e, t, n, r) {
        ...
        return (
          (o[o.length - 1] = _t.extend(o[o.length - 1], { func: n, scope: r || this.editor })),
  ...
  var OE = xu.DOM,
    ...
    ME =
      ...
      (FE.prototype.hide = function () {
        ...
        e.hidden ||
          ...
          e.inline
            ...
            : (OE.hide(e.getContainer()), OE.setStyle(e.id, 'display', e.orgDisplay)),
          (e.hidden = !0),
          e.fire('hide'));
      }),
      ...
      (FE.prototype.resetContent = function (e) {
        e === undefined ? py(this, this.startContent, { format: 'raw' }) : py(this, e),
      ...
      (FE.prototype.getContainer = function () {
        return (
          this.container || (this.container = OE.get(this.editorContainer || this.id + '_parent')),
          this.container
        );
      }),
  ...
  function FE(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      this.settings.referrer_policy &&
        ...
        xu.DOM.styleSheetLoader._setReferrerPolicy(this.settings.referrer_policy)),
  ...
  var UE,
    ...
    YE = function (e) {
      e !== $E &&
        (e ? gu(window).on('resize scroll', XE) : gu(window).off('resize scroll', XE), ($E = e));
    },
    GE = function (t) {
      var e = KE;
      delete WE[t.id];
    ...
    QE = _e(_e({}, cE), {
      ...
      setup: function () {
        ...
        /^[^:]+:\/\/\/?[^\/]+\//.test(n) &&
          ...
          /[\/\\]$/.test(n) || (n += '/'));
        var r,
          o = window.myTinymce || window.tinyMCEPreInit;
            ...
            return (
              ...
              A(r.get(n.id))
                ...
                : (GE(n) && r.fire('RemoveEditor', { editor: n }),
                  0 === KE.length && window.removeEventListener('beforeunload', UE),
                  n.remove(),
                  YE(0 < KE.length),
                  n)
            );
      ...
      _setBaseUrl: function (e) {
        (this.baseURL = new TE(this.documentBaseURL).toAbsolute(e.replace(/\/+$/, ''))),
          (this.baseURI = new TE(this.baseURL));
      }
    });
  QE.setup();
