...
!(function () {
  'use strict';
  var t = myTinymce.util.Tools.resolve('myTinymce.PluginManager'),
    u = function () {
      return (u =
        Object.assign ||
        function (t) {
  ...
  var n,
    ...
    H = myTinymce.util.Tools.resolve('myTinymce.util.Delay'),
    J = myTinymce.util.Tools.resolve('myTinymce.util.VK'),
    K = myTinymce.util.Tools.resolve('myTinymce.util.Tools'),
    X = myTinymce.util.Tools.resolve('myTinymce.dom.DOMUtils'),
    z = myTinymce.util.Tools.resolve('myTinymce.dom.TextSeeker'),
    Q = function (t, n) {
