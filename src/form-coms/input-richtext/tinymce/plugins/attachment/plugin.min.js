import { myIcons, loadingGif } from './icons';
...
!(function () {
    ...
    r = function (a, t, n) {
      ...
      t.size > s
        ...
        : ((i = a.getParam('attachment_upload_handler')),
          (o = a.getParam('attachment_assets_path') || ''),
          (c = a.dom.uniqueId()),
          (r = 'attachment_' + c),
          (l = d(t.size)),
          (p =
          ...
          (f = (function (e, t) {
            ...
            return (
              a.appendChild(n), a.appendChild(i), a.appendChild(o), (a.contentEditable = 'false'), a
            );
          })(a, { id: c, icon: o + '/loading.gif', title: t.name, size: l })),
          n(r, f),
          i(
            t,
            function (e) {
              (f = (function (e, t) {
                ...
                var o = e.dom.create('span', { id: 'attachment_' + t.id, class: 'attachment' });
                o.innerHTML = myIcons[t.icon] || myIcons['default_file'];
                return o.appendChild(i), (o.contentEditable = 'false'), o;
              })(a, { id: c, icon: p, title: t.name, size: l, src: e })),
                n(r, f);
            },
            function (e) {
              (f = (function (e, t) {
                ...
                var o = e.dom.create('span', { class: 'attachment upload_error' });
                o.innerHTML = myIcons['error'];
                return o.appendChild(i), (o.contentEditable = 'false'), o;
              })(a, { icon: _, title: t.name, size: l, message: e })),
                n(r, f);
            },
            function (e) {
              var t, n, i, o;
  ...
  myTinymce.PluginManager.add('attachment', function (e, t) {
    var n, c;
    o(e),
          ...
          if (null != n)
            for (var i = 0, o = n; i < o.length; i++) {
              ...
              (function (e) {
                ...
                r(c, a, function (e, t) {
                  var n = 'span#' + e;
                  0 < c.dom.select(n).length
                    ? c.dom.replace(t, e)
                    : c.selection.setContent(t.outerHTML);
                });
            }
        }
      });
