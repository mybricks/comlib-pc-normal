...
!(function () {
  ...
  var t,
    ...
    sn = myTinymce.util.Tools.resolve('myTinymce.dom.DOMUtils'),
    mn = myTinymce.util.Tools.resolve('myTinymce.Env'),
    hn = myTinymce.util.Tools.resolve('myTinymce.util.Delay'),
    gn = function (n, e) {
