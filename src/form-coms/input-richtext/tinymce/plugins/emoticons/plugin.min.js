...
!(function () {
  ...
  var u,
    ...
    O = myTinymce.util.Tools.resolve('myTinymce.Resource'),
    C = myTinymce.util.Tools.resolve('myTinymce.util.Delay'),
  ...
  r.add('emoticons', function (t, n) {
    var e,
      ...
      m = t.getParam('emoticons_database_id', 'myTinymce.plugins.emoticons', 'string'),
      g = P(t, f, m);
    (u = g),
      (a = function () {
        return L(i, u);
