...
!(function () {
  ...
  var n,
    ...
    e,
    r,
    o = myTinymce.util.Tools.resolve('myTinymce.PluginManager'),
    i = myTinymce.util.Tools.resolve('myTinymce.util.VK'),
    u = function (r) {
      return function (t) {
        return (
          (e = typeof (n = t)),
    ...
    L = myTinymce.util.Tools.resolve('myTinymce.util.Tools'),
    E = function (t) {
    ...
    F = myTinymce.util.Tools.resolve('myTinymce.dom.TreeWalker'),
    W = function (t) {
    ...
    dt = myTinymce.util.Tools.resolve('myTinymce.util.Delay'),
    ht = myTinymce.util.Tools.resolve('myTinymce.util.Promise'),
    pt = function (t) {
      var n = t.href;
    ...
    xt = myTinymce.util.Tools.resolve('myTinymce.util.XHR'),
    bt = function (n) {
      var e = function (t) {
