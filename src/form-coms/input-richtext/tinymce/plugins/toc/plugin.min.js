...
!(function () {
  ...
  var e,
    ...
    s = myTinymce.util.Tools.resolve('myTinymce.dom.DOMUtils'),
    f = myTinymce.util.Tools.resolve('myTinymce.util.I18n'),
    c = myTinymce.util.Tools.resolve('myTinymce.util.Tools'),
    l = function (t) {
    ...
    u = function (t) {
      ...
      for (
        ...
        if ((((o = u[e]).element.id = o.id), (r = u[e + 1] && u[e + 1].level), d === o.level))
          a += '<li>';
