...
!(function () {
  ...
  var e,
    ...
    k = myTinymce.util.Tools.resolve('myTinymce.Env'),
    v = function (e) {
      var n = k.mac
          ? {
              alt: '&#x2325;',
    ...
    A = myTinymce.util.Tools.resolve('myTinymce.util.I18n'),
    x = 'premium',
    C = d(
      [
    ...
    P = myTinymce.util.Tools.resolve('myTinymce.EditorManager'),
    M = function (e, t) {
      var n,
        a,
        o,
        ...
        h = m(
          (((n = {})[s.name] = s), (n[l.name] = l), (n[c.name] = c), (n[u.name] = u), n),
          t.get()
        );
      return (
        (r = e),
