...
!(function () {
  ...
  var N = function (e) {
    ...
    e = myTinymce.util.Tools.resolve('myTinymce.PluginManager'),
    l = Object.hasOwnProperty,
    g = myTinymce.util.Tools.resolve('myTinymce.util.Tools'),
    d = myTinymce.util.Tools.resolve('myTinymce.util.URI'),
    f = myTinymce.util.Tools.resolve('myTinymce.util.XHR'),
    h = function (e) {
                ...
                function (e) {
                  ...
                  if (r === o) {
                    var c = r,
                      s = c.parentNode;
                    0 < e.startNodeIndex &&
                      ((t = i.createTextNode(c.data.substring(0, e.startNodeIndex))),
                      s.insertBefore(t, c));
                    var l = m(e.match, a);
                    return (
                      s.insertBefore(l, c),
                      e.endNodeIndex < c.length &&
                        ((n = i.createTextNode(c.data.substring(e.endNodeIndex))),
                        s.insertBefore(n, c)),
        ...
        function (e, t, r, o) {
          ...
          (n['addToDictionary' === e ? 'word' : 'text'] = t),
            ...
            f.send({
              ...
              error: function () {
                var e =
                  c.translate('The spelling service was not found: (') + h(c) + c.translate(')');
                o(e);
              }
            });
        })
