...
!(function () {
  ...
  var e,
    ...
    M = myTinymce.util.Tools.resolve('myTinymce.dom.DOMUtils'),
    j = myTinymce.util.Tools.resolve('myTinymce.util.Promise'),
    R = myTinymce.util.Tools.resolve('myTinymce.util.XHR'),
    k = function (e) {
    ...
    de = function (e, t, n) {
      var r, i;
      n
        ? (W.setAttrib(e, 'role', 'presentation'), (r = E.fromDom(e)), L(r, 'alt', ''))
        : (U(t)
    ...
    we = myTinymce.util.Tools.resolve('myTinymce.util.ImageUploader'),
    Se = myTinymce.util.Tools.resolve('myTinymce.util.Tools'),
    xe = function (e) {
