...
!(function () {
  ...
  var e,
    ...
    u = myTinymce.util.Tools.resolve('myTinymce.PluginManager'),
    h = function () {
      return (h =
        Object.assign ||
        function (e) {
    ...
    y = s,
    x = myTinymce.util.Tools.resolve('myTinymce.util.Tools'),
    b = function (r) {
      return function (e) {
        return (
          (n = typeof (t = e)),
    ...
    $ = myTinymce.util.Tools.resolve('myTinymce.dom.TreeWalker'),
    z = function (e, t) {
    ...
    fe = function (e, t, n) {
      ...
      var a = se(e, o);
      return a.length
        ? (i.addClass(se(e, o), 'mce-match-marker-selected'), e.selection.scrollIntoView(a[0]), o)
        : -1;
    },
    de = function (e, t) {
      var n = t.parentNode;
    ...
    me = function (e, t, n, r, o, i) {
      ...
      return (
        f &&
          ((c = fe(e, t, !0)),
          t.set({ index: c, count: f, text: n, matchCase: r, wholeWord: o, inSelection: i })),
        f
      );
    },
    he = function (e, t) {
    ...
    ve = function (e, t, n, r, o) {
      ...
      r = !1 !== r;
      for (
        var l = e.getBody(), s = x.grep(x.toArray(l.getElementsByTagName('span')), pe), f = 0;
        f < s.length;
        f++
      ) {
        var d = ue(s[f]),
    ...
    ye = function (e, t, n) {
      for (
        var r, o, i = t.get(), a = x.toArray(e.getBody().getElementsByTagName('span')), u = 0;
        u < a.length;
        u++
      ) {
        var c = ue(a[u]);
        null !== c &&
          c.length &&
          (c === i.index.toString() && ((r = r || a[u].firstChild), (o = a[u].firstChild)),
          le(a[u]));
      }
    ...
    xe = myTinymce.util.Tools.resolve('myTinymce.Env'),
    be = function (i, a) {
      var t,
        e =
          ((t = d(v.none())),
