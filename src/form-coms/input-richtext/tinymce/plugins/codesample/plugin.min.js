...
!(function () {
  ...
  var e,
    n,
    t,
    a = myTinymce.util.Tools.resolve('myTinymce.PluginManager'),
    s = function (e) {
      return function () {
        return e;
      };
    ...
    p = myTinymce.util.Tools.resolve('myTinymce.dom.DOMUtils'),
    g = function (e) {
                ...
                (function (n) {
                  (function () {
                    var e = (function (u) {
                        ...
                        C = {
                              ...
                              for (var o in e) {
                                e.hasOwnProperty(o) &&
                                  ...
                                  'Object' !== (s = C.util.type(r)) || a[i(r)]
                                    ? 'Array' !== s || a[i(r)] || ((a[i(r)] = !0), l(r, n, o, a))
                          ...
                          highlightElement: function (e, n, t) {
                            ...
                            if ((C.hooks.run('before-sanity-check', o), !o.code))
                              return C.hooks.run('complete', o), void (t && t.call(o.element));
                                ...
                                for (var i in t)
                                  if (t.hasOwnProperty(i) && t[i]) {
                                    ...
                                    for (var l = 0; l < o.length; ++l) {
                                      ...
                                      for (
                                        var f = c.pattern || c, b = a.next, h = r;
                                        ...
                                        if (!(y instanceof O)) {
                                          ...
                                          if (g) {
                                            ...
                                            if (
                                              ((x -= b.value.length), (h = x), b.value instanceof O)
                                            )
                                              continue;
                                            for (
                                              var P = b;
                                              P !== n.tail && (x < _ || 'string' == typeof P.value);
                                              P = P.next
                                            )
                                              v++, (x += P.value.length);
                      ...
                      return (
                        t &&
                          ((C.filename = t.src), t.hasAttribute('data-manual') && (C.manual = !0)),
                        C.manual ||
                ...
                !(function (t) {
                  ...
                  (t.languages.csharp = t.languages.extend('clike', {
                    ...
                    'class-name': [
                      ...
                      { pattern: r(/(\busing\s+)<<0>>(?=\s*=)/.source, [f]), lookbehind: !0 },
                      { pattern: r(/(\b<<0>>\s+)<<1>>/.source, [u, b]), lookbehind: !0, inside: x },
                      {
                          ...
                          (function b(e) {
                            for (var n = 0; n < e.length && !(m >= f.length); n++) {
                              var t,
                                ...
                                c,
                                d = e[n];
                              'string' == typeof d || (d.content && 'string' == typeof d.content)
                                ? ((t = f[m]),
                                  (a = p.tokenStack[t]),
