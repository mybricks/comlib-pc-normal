...
const prompts = `
  ...
  {columns: [
    {key: "column_1", widthOption: 'span', span: 8, slot: "slot_1", content: ["amc.normal-h5.text"]}, 
  ...
  答：{columns: [
    {key: "column_0", slot: "slot_0", content: ["amc.normal-h5.text"]},
    {key: "column_1", slot: "slot_1", content: ["amc.normal-h5.table"]}
  ]}
  `;
