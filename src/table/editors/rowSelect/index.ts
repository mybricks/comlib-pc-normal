  ...
  '.ant-table-thead .ant-table-cell.ant-table-selection-column': {
    ...
    style: [
      ...
      },
      {
        ...
        target: ({ id }) => `table thead.ant-table-thead tr th.ant-table-cell.ant-table-selection-column${getFilterSelector(id)}`,
      },
      {
        title: '内容',
        catelog: '默认',
        ...
        target: ({ id }) => `table .ant-table-tbody tr .ant-table-cell.ant-table-selection-column${getFilterSelector(id)}`,
      },
      {
        title: '勾选框',
        catelog: 'Hover',
